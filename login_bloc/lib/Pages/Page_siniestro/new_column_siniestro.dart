...
class NewColumnSiniestro extends StatelessWidget {
  double height = 20.0;
  NewColumnSiniestro({Key? key}) : super(key: key);
        ...
        Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              TextInput(
                  hintText:
                      "${localization.dictionary(Strings.dataTypeHint)} *",
                  inputType: TextInputType.text,
              ...
              ButtonLarge(
                  ...
                  onPressed: () {
                    if (_nameController.text.isEmpty ||
                      ...
                      SiniestroRepository.shared.addColumn(
                          tablaName: "siniestro",
