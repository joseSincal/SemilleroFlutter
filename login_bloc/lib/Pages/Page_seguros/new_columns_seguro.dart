...
class NewColumnSeguro extends StatelessWidget {
  double height = 20.0;
  NewColumnSeguro({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(children: [
        ...
        const AppBarTitle(title: "Add campo seguro"),
        Container(
              ...
              ButtonLarge(
                  ...
                  onPressed: () {
                    if (_nameController.text.isEmpty ||
                      ...
                      SeguroRepository.shared.addColumn(
                          tablaName: "seguro",
